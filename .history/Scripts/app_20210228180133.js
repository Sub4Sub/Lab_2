          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0" id ="headerList">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" id ="headerList">
                <li class="nav-item">
                  <a class="nav-link" aria-current="page" href="contact_TEST.html"><i class="fas fa-user fa-lg"></i> Login</a>
                </li>
   ...
   function displayX()
    {
      ...
      <div class="row justify-content-lg-center g-3">
      <form id="loginForm" novalidate style="padding: 5px;">
      ...
      <div class="text-right">
        <button id="xx" type="submit" class="btn btn-primary btn-lg">Login</button>
      </div>
      <button id="login2" type="submit" class="btn btn-primary btn-lg">Login2</button>
    </form>
      </div>`;
