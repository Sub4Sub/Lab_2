...
mainContent.append(newDivTag);
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0" id ="headerList">
                ...
                <li class="nav-item">
                  <a class="nav-link" aria-current="page" href="login copy.html"><i class="fas fa-user fa-lg"></i> Register</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    */
    function addHumanResourcesButton()
    {
      ...
      let aboutUsLink = document.getElementById("headerList");
      ...
      <ul>
      <li class="nav-item">
        <a class="nav-text" id="HumanResourcesLink" aria-current="page" href="human-resources.html"><i class="fas fa-globe fa-lg"></i> Human Resources</a>
      </li>
      </ul>
      `
   ...
   function displayLogin()
    {
      ...
      <h1 class="display-4">Login</h1>
        <form>
          ...
          <button id="sendButton" type="submit" class="btn btn-primary"><i class="fas fa-envelope fa-lg"></i> Login</button>
          </div>
          </form>
      </div>
      ...
      $("#sendButton").on("click", function() 
      {
        let x = $("#contactName").val();

        location.href = './login.html';

        mainContent.append(x);
